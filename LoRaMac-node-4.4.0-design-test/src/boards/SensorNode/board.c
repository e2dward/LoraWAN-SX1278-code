...
//    GpioInit( &ioPin, GPS_POWER_ON, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1 );
    ...
    GpioInit( &Led4, LED_4, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
	  ...
	  GpioInit(&Led_R,LED_R,PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
	  GpioInit(&Led_G,LED_G,PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
		GpioInit(&Led_B,LED_B,PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
