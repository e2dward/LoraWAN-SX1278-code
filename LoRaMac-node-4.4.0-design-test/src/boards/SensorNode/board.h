...
#define RADIO_MOSI                                  PB_5                 //new
#define RADIO_MISO                                  PB_4                 //new
#define RADIO_SCLK                                  PB_3                 //new
#define RADIO_NSS                                   PA_15                //new
...
#define RADIO_ANT_SWITCH_HF                         PA_2                 //new，SX1276高低频的选择
#define RADIO_ANT_SWITCH_LF                         PA_3                 //new,PA0,PA2是LED_R,LED_G指示灯，共阳极


#define LED_R                                       PA_0                  //红色LED灯
#define LED_G                                       PA_1                  //绿色LED灯
#define LED_B                                       PB_12                 //蓝色LED灯
